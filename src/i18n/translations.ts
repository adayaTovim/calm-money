...
const translations = {
  en: {
    ...
    export_desc: 'Download a full Excel report with summary, income, expenses, category breakdown and monthly analysis.',
    export_sheet_summary: 'Summary',
    export_sheet_income: 'Income',
    export_sheet_expenses: 'Expenses',
    export_sheet_by_category: 'By Category',
    export_sheet_by_month: 'By Month',
    export_report_title: 'Calm Money — Financial Report',
    export_period: 'Period',
    export_metric: 'Metric',
    export_value: 'Value',
    export_total_income: 'Total Income (received)',
    export_pending_income: 'Pending Income',
    export_total_expenses: 'Total Expenses',
    export_balance: 'Balance',
    export_free_money: 'Free Money',
    export_free_money_pct: 'Free Money %',
    export_health_score: 'Financial Health Score',
    ...
    export_pct_expenses: '% of Expenses',
    export_month: 'Month',
    export_income_col: 'Income (₪)',
    export_expenses_col: 'Expenses (₪)',
    export_free_col: 'Free Money (₪)',
    export_total: 'Total',
    export_total_received: 'Total Received',
    export_total_pending: 'Total Pending',
    delete_this_only: 'Delete this only',
    delete_all_recurring: 'Delete all recurring',
    language: 'Language',

    // Upload (already have upload_nav above, keeping consistent)
    upload_nav: 'Import Excel',
    upload_title: 'Import from Excel',
    ...
    upload_skipped: (n: number) => `${n} rows skipped (empty or invalid)`,
    upload_template: 'Download template',
    upload_template_desc: 'Not sure about the format? Download our Excel template.',
    upload_auto_import: 'Auto import (skip review)',
    upload_review: 'Review before importing',
    upload_tab_income: (n: number) => `Income (${n})`,
    upload_tab_expense: (n: number) => `Expenses (${n})`,
    upload_status: 'Status',
    upload_source: 'Source',
    upload_category: 'Category',
    upload_supplier: 'Supplier',
  ...
  he: {
    ...
    cancel: 'ביטול',
    delete_confirm: 'מחק',
    export_btn: 'ייצוא דוח',
    export_desc: 'הורד דוח אקסל מלא עם סיכום, הכנסות, הוצאות, פירוט לפי קטגוריה וניתוח חודשי.',
    export_sheet_summary: 'סיכום',
    export_sheet_income: 'הכנסות',
    ...
    export_metric: 'מדד',
    export_value: 'ערך',
    export_total_income: 'סה"כ הכנסות (התקבלו)',
    export_pending_income: 'הכנסות ממתינות',
    export_total_expenses: 'סה"כ הוצאות',
    export_balance: 'מאזן',
    export_free_money: 'כסף פנוי',
    export_free_money_pct: 'אחוז כסף פנוי',
    export_health_score: 'ציון בריאות פיננסית',
    export_amount: 'סכום (₪)',
    export_source: 'מקור',
    export_date: 'תאריך',
    export_status: 'סטטוס',
    export_category: 'קטגוריה',
    export_supplier: 'ספק',
    export_pct_expenses: '% מההוצאות',
    export_month: 'חודש',
    export_income_col: 'הכנסות (₪)',
    export_expenses_col: 'הוצאות (₪)',
    export_free_col: 'כסף פנוי (₪)',
    export_total: 'סה"כ',
    export_total_received: 'סה"כ התקבל',
    export_total_pending: 'סה"כ ממתין',
    delete_this_only: 'מחק רק את זה',
    delete_all_recurring: 'מחק את כל החוזרים',
    language: 'שפה',

    // Upload
    upload_nav: 'ייבוא אקסל',
    upload_title: 'ייבוא מאקסל',
    ...
    upload_skipped: (n: number) => `${n} שורות דולגו (ריקות או לא תקינות)`,
    upload_template: 'הורד תבנית',
    upload_template_desc: 'לא בטוח לגבי הפורמט? הורד את תבנית האקסל שלנו.',
    upload_auto_import: 'ייבוא אוטומטי (ללא סקירה)',
    upload_review: 'סקירה לפני ייבוא',
    upload_tab_income: (n: number) => `הכנסות (${n})`,
    upload_tab_expense: (n: number) => `הוצאות (${n})`,
    upload_status: 'סטטוס',
    upload_source: 'מקור',
    upload_category: 'קטגוריה',
    upload_supplier: 'ספק',
