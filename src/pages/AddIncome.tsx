...
export function AddIncome() {
  ...
  return (
    <div className="p-6 max-w-lg mx-auto">
      ...
      <h1 className="text-2xl font-bold text-gray-800 mb-1">Add income</h1>
      ...
      <Card className="space-y-4">
        ...
        <div>
          <label className="block text-sm font-medium text-gray-600 mb-1">Source <span className="text-gray-300">(optional)</span></label>
          <input placeholder="e.g. Client name, project..."
            value={form.source}
